...
const products = [
  {
    id: 1,
    name: 'Bright Skin Essentials Kit',
    category: 'CLEANSE GLOW REPEAT',
    price: 750,
    originalPrice: 825,
  ...
  {
    id: 2,
    name: 'Acne Essential Mini Kit',
    category: 'UNCLOG & DETOXIFY YOUR PORES',
    price: 740,
    originalPrice: 825,
  ...
  {
    id: 3,
    name: 'Dark Spot & Pigmentation Repair Kit',
    category: 'EXPERT PIGMENTATION REPAIR ROUTINE',
    price: 1200,
    originalPrice: 1330,
