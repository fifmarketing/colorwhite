...
interface ContactClientProps {
  contactPage: SiteSettings['contactPage']
  footer: SiteSettings['footer']
}

export function ContactClient({ contactPage, footer }: ContactClientProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-5xl md:text-7xl font-light tracking-tight text-foreground text-balance">
              <HighlightedText text={contactPage.heroTitle} highlightClass="font-semibold text-primary" />
            </h1>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-6 group cursor-pointer">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <a href={`mailto:${contactPage.email}`} className="text-foreground/70 font-light hover:text-primary transition-all duration-300 ease-out cursor-pointer">
                      {contactPage.email}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-6 group cursor-pointer">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <a href={`tel:${contactPage.phone.replace(/\s/g, '')}`} className="text-foreground/70 font-light hover:text-primary transition-all duration-300 ease-out cursor-pointer">
                      {contactPage.phone}
                    </a>
                  </div>
                </div>
